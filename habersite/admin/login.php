...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sorgu = "SELECT * FROM yazar_tablo WHERE yazar_eposta='$yazar_eposta' AND
   yazar_sifre='$yazar_sifre'";
   ...
   <div class="container">
    ...
    <div class="col-12">
    <button type="submit" class="btn btn-dark float-end">GiriS</button>
    </div>
    </form>
 </div>
 </div>
