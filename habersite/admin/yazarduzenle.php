...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
 ...
 yazar_sifre ='$yazar_sifre', yazar_adsoyad='$yazar_adsoyad'WHERE yazar_id='$yazar_id'";
...
<form action="yazarduzenle.php" method="post">
 ...
 value="<?php echo $kayit['yazar_eposta'];?>">
 </div>
 <div class="form-group mb-3">
 <label>Yazar Sifre</label>
 <input type="password" class="form-control" name="yazarsifre"
 value="<?php echo $kayit['yazar_sifre'];?>">
 </div>
 <div class="form-group mb-3">
 <label>Yazar Adi Soyadi</label>
 <input type="text" class="form-control" name="yazaradsoyad"
 value="<?php echo $kayit['yazar_adsoyad'];?>">
 </div>
 <input type="hidden" name="yazarid"
 value="<?php echo $kayit['yazar_id'];?>" />
